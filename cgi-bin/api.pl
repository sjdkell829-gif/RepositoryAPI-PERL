...
# ─────────────────────────────────────────
# HEALTH CHECK — GET /cgi-bin/api.pl/health
# ─────────────────────────────────────────
...
# ─────────────────────────────────────────
    ...
    if (!$nuevo->{nombre} || !defined $nuevo->{edad} || !defined $nuevo->{nivel_poder}) {
        print encode_json({ error => "Campos requeridos: nombre, edad, nivel_poder" });
        exit;
    }
